/* ================================================================
   MEXICANOS EN TORONTO — Shared JS
   Used by: index.html, directory.html, about.html
================================================================ */
'use strict';

/* ════ CONFIG — update GAS_URL after each new GAS deployment ════
   PLACEHOLDER VALUES: everything below needs to be swapped for the
   real deployment before this goes live. See the setup steps sent
   alongside this file. ════ */
window.SFT = window.SFT || {};
SFT.GAS_URL    = 'https://script.google.com/macros/s/AKfycbwKDQ9OYrABH-7h14fM-WcBGdZzxeMeANscZlfWK52MLtvuuGz7JtjD7iERoTndeAJk/exec'; // TODO: new Apps Script deployment
...
SFT.LOGO_URL    = 'https://placehold.co/200x200/B8232B/ffffff/png?text=MT'; // TODO: replace with real logo
SFT.PAGE_SIZE  = 12;
...
const STRINGS = {
  en: {
    portalSub:'Community Directory', heroBadge:'MEXICANOS EN TORONTO · OFFICIAL DIRECTORY',
    heroLine1:'In Toronto', heroLine2:'We Have It All',
    heroTagline:'Connect · Publish · Quote · Grow',
    heroSub:'Your trusted platform to advertise businesses, offer services, and request quotes in the Mexicanos en Toronto community.',
    ...
    howSub:'Three steps to connect with the entire Mexicanos en Toronto community.',
    ...
    photosLabel:'The community', photosTitle:'Mexicanos en Toronto in action',
    ...
    trustBiz1:'Tamales La Esperanza', trustBiz2:'Toronto Resident', trustBiz3:'Studio Belleza AR',
    ctaBannerTitle:'Ready to grow?',
    ctaBannerSub:'Join hundreds of businesses already part of the most complete directory in Mexicanos en Toronto.',
    ...
    onboardTitle:'Do you have a business serving the Toronto Mexican community?',
    ...
    bannerDesc:'Promote your business at the top of every page for <strong>30 days</strong> — $29.99 CAD via PayPal.',
    bannerCheck:'Yes! Feature my business — <strong>$29.99 CAD</strong> / 30 days',
    ...
    fReqTitle:'Request Title', fBudgetMin:'Budget Min (CAD)', fBudgetMax:'Budget Max (CAD)',
    ...
    fOffTitle:'Offer Title', fPrice:'Price (CAD)', fBizYourName:'Business / Your Name',
    ...
    footerTagline:'The official business directory and marketplace for the Mexicanos en Toronto community.',
    ...
    aboutHero:'About Mexicanos en Toronto', aboutSub:'The story behind the community',
    featuredTitle:'Supported by the community', featuredSub:'Businesses that invest in visibility to better serve Mexicanos en Toronto.',
    featuredUpsell:'Want to appear here? Feature your business for just', featuredUpsellBtn:'Feature my business',
    featPlaceholderType:'$29.99 CAD · 30 days · PayPal', featPlaceholderDesc:'Be the first to get featured and reach every visitor of Mexicanos en Toronto.', featPlaceholderCta:'Feature now →',
    aHeroTitle:'Connecting our <span class="accent">community</span>',
    aHeroSub:'We are the community directory that connects local businesses with Mexicanos en Toronto residents — free, easy, and built to grow with you.',
    aMissionLabel:'Our Mission', aMissionTitle:'Making visible what already exists in Toronto',
    aMissionBody1:'Mexicanos en Toronto has incredible businesses, real talent, and a community that wants to support each other. The problem was always visibility: residents did not know what was available, and businesses had no place to advertise without spending on social media or flyers.',
    ...
    aVal1Title:'Community First', aVal1Desc:'We are from Mexicanos en Toronto. Every decision we make is designed to benefit local residents and businesses — not outside investors.',
    ...
    aVal5Title:'Bilingual', aVal5Desc:'Mexicanos en Toronto is a diverse community. That is why our platform works equally well in Spanish and English — no language barriers.',
    ...
    aOriginBody1:'It all started when a Toronto resident needed a plumber and did not know who to call. There was no local directory, no organized group, no easy way to find services in the neighborhood.',
    aOriginBody2:'At the same time, there were plumbers, electricians, seamstresses, and cooks in Toronto with no way to advertise beyond posting flyers on poles.',
    aOriginBody3:'The solution was simple: create the space Mexicanos en Toronto deserved. A place where both sides — the seeker and the provider — could easily find each other.',
    aTeamLabel:'The Team', aTeamTitle:'Made by neighbors, for neighbors',
    aTeamSub:'We are a small team committed to making Mexicanos en Toronto a more connected and prosperous community.',
    ...
    aCtaTitle:'Do you have a business in Toronto?', aCtaSub:'Register it for free today and start connecting with your community.',
    aCollabTitle:'Want to collaborate?', aCollabDesc:'Write to us and let\'s build something great together.', aCollabBtn:'Contact us',
  },
  es: {
    portalSub:'Directorio Comunitario', heroBadge:'MEXICANOS EN TORONTO · DIRECTORIO OFICIAL',
    heroLine1:'En Toronto', heroLine2:'Lo Tenemos Todo',
    heroTagline:'Conecta · Publica · Cotiza · Crece',
    heroSub:'Tu plataforma confiable para anunciar negocios, ofrecer servicios y solicitar cotizaciones en la comunidad Mexicanos en Toronto.',
    ...
    howSub:'Tres pasos para conectar con toda la comunidad de Mexicanos en Toronto.',
    ...
    photosLabel:'La comunidad', photosTitle:'Mexicanos en Toronto en acción',
    ...
    trustBiz1:'Tamales La Esperanza', trustBiz2:'Residente de Toronto', trustBiz3:'Studio Belleza AR',
    ctaBannerTitle:'¿Listo para crecer?',
    ctaBannerSub:'Únete a cientos de negocios que ya forman parte del directorio más completo de Mexicanos en Toronto.',
    ...
    onboardTitle:'¿Tienes un negocio para la comunidad mexicana de Toronto?',
    ...
    bannerDesc:'Promociona tu negocio en la parte superior de cada página por <strong>30 días</strong> — $29.99 CAD vía PayPal.',
    bannerCheck:'¡Sí! Destacar mi negocio — <strong>$29.99 CAD</strong> / 30 días',
    ...
    fReqTitle:'Título de la Solicitud', fBudgetMin:'Presupuesto Mín (CAD)', fBudgetMax:'Presupuesto Máx (CAD)',
    ...
    fOffTitle:'Título de la Oferta', fPrice:'Precio (CAD)', fBizYourName:'Negocio / Tu Nombre',
    ...
    footerTagline:'El directorio oficial de negocios y mercado de la comunidad Mexicanos en Toronto.',
    ...
    aboutHero:'Acerca de Mexicanos en Toronto', aboutSub:'La historia detrás de la comunidad',
    featuredTitle:'Apoyados por la comunidad', featuredSub:'Los negocios que invierten en visibilidad para servir mejor a Mexicanos en Toronto.',
    featuredUpsell:'¿Quieres aparecer aquí? Destaca tu negocio por solo', featuredUpsellBtn:'Destacar mi negocio',
    featPlaceholderType:'$29.99 CAD · 30 días · PayPal', featPlaceholderDesc:'Sé el primero en destacarse y llega a todos los visitantes de Mexicanos en Toronto.', featPlaceholderCta:'Destacar ahora →',
    aHeroTitle:'Conectando a <span class="accent">nuestra comunidad</span>',
    aHeroSub:'Somos el directorio comunitario que une a los negocios locales con los vecinos de Mexicanos en Toronto — gratis, fácil y construido para crecer contigo.',
    aMissionLabel:'Nuestra Misión', aMissionTitle:'Hacer visible lo que ya existe en Toronto',
    aMissionBody1:'Mexicanos en Toronto tiene negocios increíbles, talento real y una comunidad que quiere apoyarse. El problema siempre fue la visibilidad: los vecinos no sabían qué había disponible, y los negocios no tenían dónde anunciarse sin gastar en redes sociales o volantes.',
    ...
    aVal1Title:'Comunidad Primero', aVal1Desc:'Somos de Mexicanos en Toronto. Cada decisión que tomamos está pensada para beneficiar a los vecinos y negocios locales — no a inversionistas externos.',
    ...
    aVal5Title:'Bilingüe', aVal5Desc:'Mexicanos en Toronto es una comunidad diversa. Por eso nuestra plataforma funciona igual de bien en español que en inglés — sin barreras de idioma.',
    ...
    aOriginBody1:'Todo empezó cuando un vecino de Toronto necesitaba un plomero y no sabía a quién llamar. No había ningún directorio local, ningún grupo organizado, ninguna forma fácil de encontrar servicios en la colonia.',
    aOriginBody2:'Al mismo tiempo, había plomeros, electricistas, costureras y cocineras en Toronto sin manera de anunciarse más allá de pegar carteles en postes.',
    aOriginBody3:'La solución fue simple: crear el espacio que Mexicanos en Toronto merecía. Un lugar donde los dos lados — el que busca y el que ofrece — pudieran encontrarse fácilmente.',
    aTeamLabel:'El Equipo', aTeamTitle:'Hecho por vecinos, para vecinos',
    aTeamSub:'Somos un equipo pequeño pero comprometido con hacer de Mexicanos en Toronto una comunidad más conectada y próspera.',
    ...
    aCtaTitle:'¿Tienes un negocio en Toronto?', aCtaSub:'Regístralo gratis hoy y empieza a conectar con tu comunidad.',
...
function applyBranding() {
  ...
  /* Footer logo (small white icon in the site footer) is a plain <img>,
     not the header's logoIconWrap slot — keep it in sync with the same
     branding source so a logo/favicon update doesn't go half-applied. */
  if (SFT.FAVICON_URL) {
    document.querySelectorAll('.footer-logo-img').forEach(img => {
      img.src = SFT.FAVICON_URL;
    });
  }
}
...
/* ════ SHARE ════
   Each content type now lives on its own page after the directory/
   requests/offers split, so the share link must point at the page
   that actually renders that type — not always directory.html. */
function shareItem(type, slug, title) {
  const base = window.location.origin;
  const page = type === 'request' ? 'requests.html' : type === 'offer' ? 'offers.html' : 'directory.html';
  const url = base + '/' + page + '?' + type + '=' + encodeURIComponent(slug);
  if (navigator.share) {
...
function openDetail(type, item, allItems) {
  ...
  if (type === 'biz') {
    ...
    const budget = (item.budgetMin||item.budgetMax) ? `$${item.budgetMin||0}${item.budgetMax&&item.budgetMax!=item.budgetMin?' – $'+item.budgetMax:''} CAD` : T('negotiable');
    ...
    const price = item.price ? `$${Number(item.price).toLocaleString()} CAD` : T('priceOnRequest');
  ...
  /* ── QR Code: only shown for businesses ───────────────────────
     ...
     mexicanos-en-toronto.com, driving all traffic through the website.
